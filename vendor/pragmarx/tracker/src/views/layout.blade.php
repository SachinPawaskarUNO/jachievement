		    ...
		    <div class="navbar-default sidebar" role="navigation">
			    <div class="sidebar-nav navbar-collapse">
				    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{route('tracker.stats.index')}}?page=livefeed" class="{{ Session::get('tracker.stats.page') =='livefeed' ? 'active' : '' }}" ><i class="fa fa-dashboard fa-fw"></i> @lang("tracker::tracker.livefeed") <span class="{{ Session::get('tracker.stats.page') =='livefeed' ? 'fa arrow' : '' }}"></span></a>
                        </li>
                        <li>
