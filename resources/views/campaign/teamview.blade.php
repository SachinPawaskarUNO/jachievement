                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped cds-datatable">
                                    ...
                                    @foreach($teamInfo as $team)
                                        <tr>
                                            <td class="table-text"><a href="view/{{$team->teamtoken}}">
                                                    <div>{{$team->teamname}}</a>
                            </div></td>
                            <td class="table-text">
                                <div>${{number_format($team->teamgoal,2)}}</div>
                            </td>
                            <td class="table-text">
                                <div>{{$team->teamdate}}</div>
                            </td>
                            <td class="table-text">
                                <div>{{$team->teamtitle}}</div>
                            </td>
                            </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped cds-datatable">
                                ...
                                @foreach($teamIndividuals as $teamIndi)
                                    <tr>
                                        <td class="table-text"><a href="view/{{$team->teamtoken}}">
                                                <div>{{$teamIndi->teamname}}</a>
                                                </div>
                                        </td>
                                        <td class="table-text">
                                            <div>${{number_format($teamIndi->teamgoal,2)}}</div>
                                        </td>
                                        <td class="table-text">
                                            <div>{{$teamIndi->teamtitle}}</div>
                                        </td>
                                    </tr>
