        ...
        <div class="container">
            <div class="col-md-9" >
                ...
                <div class="panel panel-default">
                    ...
                    <p class="team-description" id="P_1">{{$team->content}}</p>
                </div>
                <br>
                <br>
                <div class="closing-buttons" align="center" id="button-donate">
                    <a class="btn btn-lg btn-primary" href="{{ action('CampaignController@joinTeam', [$team->id]) }}" id="member_join">Join Our Team</a>
                    <a class="btn btn-lg btn-primary" href="{{ url('/donation/donate')}}" id="member_donate">Donate to our goal</a>
                </div>
                <div>
