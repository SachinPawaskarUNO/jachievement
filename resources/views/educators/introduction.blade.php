...
@section('content')
    ...
    <div align="center">
        <a href="{{ url('/educators/interestform') }}" class="btn btn-success btn-lg" ID="SignUp">Sign up as an
            Educator</a>
    </div>
    <br>
        ...
        <div class="container" ID="2">
            ...
            <div class="row" ID="4">
                <div class="col-md-6" ID="5">
                    <img class="img-responsive" src="{{$contents['Top Picture']}}" alt="Educator" width="100%"
                         height="auto" ID="6"/>
                </div>
