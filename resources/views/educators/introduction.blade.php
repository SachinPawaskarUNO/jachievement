    ...
    <div class="container-fluid" style="background-color:rgb(245,245,245)">
        ...
        <br>
            <div class="row" >
                ...
                <h4 class="text-left"><span class="glyphicon glyphicon-star-empty" style="margin-bottom:120px"></span> IMPORTANCE OF STAYING IN SCHOOL</h4>
                ...
                <h4 class="text-left"> <span class="glyphicon glyphicon-star-empty"></span>PREPARATION FOR THE REAL WORLD</h4>
                ...
                <h4 class="text-left"> <span class="glyphicon glyphicon-star-empty"></span> EDUCATOR-RESPECTED AND RECOMMENDED</h4>
...
<div class="col-md-4">
 ...
 <br>
 <h3 class="text-center"> <a href="interestform" id="EducatorSignUp">Please sign-up here! </a> </h3>
</div>
<div class="col-md-4"></div>
</div>
...
<h2 class="text-center"> Watch the Video</h2>        
        <br/>
            <div align:"center" class="row" style="align: center">
