                        ...
                        <div class="program">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar"
                                     aria-valuenow={{$teamMember->current}} aria-valuemin="0" aria-valuemax="100"
                                     style=" min-width:2em; width: {{$teamMember->current}}%"></div>
                            </div>
                    ...
                    <div class="closing-buttons" align="center" id="button-donate">
                        ...
                        @if($data['button_show'] == 'true')
                            <a class="btn btn-sm btn-success"
                               href="{{ action('CampaignController@joinTeam', [$teamMember->token]) }}"
                               id="member_join">Join Our Team</a>
                        @endif
                        ...
                        @if($data['editable'])
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-sm btn-success"
                               href="{{ action('CampaignController@editTeamMember', [$teamMember->token]) }}"
                               id="editLink">Edit Page Contents</a>
                        @endif
                        <br><br><br><br>
                    </div>
                </div>
