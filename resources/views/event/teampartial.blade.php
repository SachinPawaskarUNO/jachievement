...
@else
    <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
            ...
            <label class="control-label" style="font-weight: normal !important;"> &nbsp; Automatically join team after
                creating?</label>
        </div>
    </div>
    ...
    <div class="form-group" style="display:none" id="div3">
        ...
        <div class="col-md-4">
            <input type="range" id="personalFundraisingGoalRange" min="0" max="10000" step="50" value="500"
                   onChange="changePersonalGoalText()">
        </div>
        <div class="col-md-3">
