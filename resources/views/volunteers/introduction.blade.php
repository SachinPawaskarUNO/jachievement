...
@section('content')
    ...
    <div align="center">
        <a href="{{ url('/volunteers/interestform') }}" class="btn btn-success btn-lg" ID="SignUP">Sign up as a
            Volunteer</a>
    </div>
    <br>
        ...
        <div class="container" ID="2">
            ...
            <div class="row" ID="4">
                <div class="col-md-6" ID="5">
                    <img class="img-responsive" alt="Volunteering with Junior Achievement"
                         src="{{$contents['Top Picture']}}" width="100%" height="auto" ID="6"/>
                </div>
                <div class="col-md-6" ID="7">
                    ...
                    <div>
                        ...
                        <div class="col-md-11" ID="16"><h4>JUNIOR ACHIEVEMENT PROVIDES AN AMAZING AND REWARDING
    ...
    <div class="container-fluid" ID="25" style="background-color:rgb(245,245,245)">
        ...
        <div class="container" ID="26">
            ...
            <br/>
            <div align:
            "center" class="col-md-2 style="align: center" ID="28">
        </div>
        <div align:
        "center" class="col-md-8 style="align: center" ID="29" >
        <div class="embed-responsive embed-responsive-16by9 text-center" ID="30">
            <div class="video-embed" style="text-align:center" ID="31">
                <iframe allowfullscreen="" frameborder="0" height="100" src="{{$contents['Bottom Video']}}" width="300"
                        ID="32"></iframe>
            </div>
        </div>
    </div>
