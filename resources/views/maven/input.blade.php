...
@section('content')
            ...
            <div id="form-{{ $locale }}" class="tab-pane fade{!! ($locale == $current_locale) ? ' in active' : '' !!}">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <div class="pull-right text-muted">{{--<span class="bg-danger">&nbsp;{{ $locale }}&nbsp;</span>--}}
                            &nbsp;</div>
    ...
    <div class="text-right" style="margin-top:10px;">
        <a href="{{ route('maven.index') }}" class="btn icon-btn btn-default" type="button"
           data-dismiss="modal">{{ trans('maven.cancel') }}</a>
