...
<form action="{{ route('maven.index') }}" method="get" role="search">
    <div class="input-group col-md-4 col-sm-6">
        <input type="text" class="form-control" placeholder="@lang('maven.search')" name="q"
               value="{{ (isset($smoothness)) ? $smoothness->values->get('q') : '' }}">
        <span class="input-group-btn">
            <a href="{{ route('maven.index') }}" class="btn btn-default" type="submit">&nbsp;<i
