...
class ProgramsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Program::create(['name' => 'JA Ourselves (Kindergarten)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
        ...
        Program::create(['name' => 'JA Our Families (Grade 1)','implementation' => 'Classroom-Based','entrepreneurship' => '2',
            ...
            'description' => 'JA Our Families explains how family members\' jobs and businesses contribute to the well-being of the family and of the community. The program introduces the concept of needs and wants and explores the ways families plan for and acquire goods and services. Students analyze their own skills to determine ways they can support their families.','grade_id' => '1', 'created_by' => 'System',
            'updated_by' => 'System', 'created_at' => date_create(), 'updated_at' => date_create()]);

        Program::create(['name' => 'JA Our Community (Grade 2)','implementation' => 'Classroom-Based','entrepreneurship' => '0',
        ...
        Program::create(['name' => 'JA Our Region (Grade 4)','implementation' => ' Classroom-Based','entrepreneurship' => '2',
            ...
            'description' => 'JA Our Region introduces students to entrepreneurship and how entrepreneurs use resources to produce goods and services in a region. Students operate a hypothetical hot dog stand to understand the fundamental tasks performed by a business owner and to track the revenue and expenses of a business.', 'grade_id' => '1',
            'created_by' => 'System', 'updated_by' => 'System', 'created_at' => date_create(),
            'updated_at' => date_create()]);
...
//            'updated_by' => 'System', 'created_at' => date_create(), 'updated_at' => date_create()]);
        ...
        Program::create(['name' => 'JA Our Nation (Grade 5)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
...
//            'updated_at' => date_create()]);
        ...
        Program::create(['name' => 'JA Economics for Success (Grade 6-8)','implementation' => 'Classroom-Based','entrepreneurship' => '0',
            ...
            'description' => 'JA Economics for Success gives students the information needed to build strong personal finances, a cornerstone to a happy, secure life. Students learn the importance of exploring career options based on their skills, interests, and values. They also learn about spending money within a budget; saving and investing wisely; and using credit cautiously.','grade_id' => '2', 'created_by' => 'System',
            'updated_by' => 'System', 'created_at' => date_create(), 'updated_at' => date_create()]);

        Program::create(['name' => 'JA Global Market Place (Grade 6-8)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
        ...
        Program::create(['name' => 'JA Its my Future (Grade 6-8)','implementation' => 'Classroom-Based','entrepreneurship' => '3',
            ...
            'description' => 'JA It’s My Future provides practical information about preparing for the working world. Students learn about career clusters, high-growth jobs, career planning, and creating a personal brand. And, through a scavenger hunt, they are introduced to the basic aspects of job hunting.', 'grade_id' => '2',
            'created_by' => 'System', 'updated_by' => 'System', 'created_at' => date_create(),
            'updated_at' => date_create()]);

        Program::create(['name' => 'JA Be Entrepreneurial (Grade 9-12)','implementation' => 'Classroom-Based','entrepreneurship' => '2',
        ...
        Program::create(['name' => 'JA Career Success (Grade 9-12)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
            ...
            'description' => 'JA Career Success equips students with the knowledge required to get and keep a job in high-growth industries. Students will explore the crucial workplace skills employers seek but often find lacking in young employees. Students also will learn about valuable tools to find that perfect job, including resumes, cover letters, and interviewing techniques.', 'grade_id' => '3',
            'created_by' => 'System', 'updated_by' => 'System', 'created_at' => date_create(),
            'updated_at' => date_create()]);
...
//            'updated_by' => 'System', 'created_at' => date_create(), 'updated_at' => date_create()]);
        ...
        Program::create(['name' => 'JA Exploring Economics (Grade 9-12)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
            ...
            'description' => 'JA Exploring Economics uses hands-on activities to explain complex economic concepts such as supply and demand, inflation, and the production, distribution and consumption of goods. It gives insight into the effect governments and individuals have on the global economy— and on the price of a loaf of bread.','grade_id' => '3', 'created_by' => 'System',
            'updated_by' => 'System', 'created_at' => date_create(), 'updated_at' => date_create()]);


        Program::create(['name' => 'JA Personal Finance (Grade 9-12)','implementation' => 'Classroom-Based','entrepreneurship' => '0',
            ...
            'description' => 'JA Personal Finance explores the fundamental elements of personal finances: earnings, saving and investing, budgeting, credit, risk management, and giving. Students apply these elements to a personal financial plan that allows them to set specific goals for their lifelong financial needs and desired quality of life.', 'grade_id' => '3',
            'created_by' => 'System', 'updated_by' => 'System', 'created_at' => date_create(),
            'updated_at' => date_create()]);

        Program::create(['name' => 'JA Titan (Grade 9-12)','implementation' => 'Classroom-Based','entrepreneurship' => '2',
        ...
        Program::create(['name' => 'JA Economics (semester program; Grade 11-12)','implementation' => 'Classroom-Based','entrepreneurship' => '1',
